...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "hover:bg-gray-100 focus:bg-blue-50 focus:text-blue-900 text-gray-900 relative flex w-full cursor-default items-center gap-2 rounded-sm py-2 pr-8 pl-3 text-sm outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 transition-colors",
        className,
      )}
      {...props}
    >
