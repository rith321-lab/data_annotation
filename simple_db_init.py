#!/usr/bin/env python3
"""
Simple database initialization for Verita AI
...
def create_simple_db():
    ...
    cursor.execute('SELECT id FROM users WHERE email = ?', (settings.FIRST_SUPERUSER_EMAIL,))
    ...
    if not existing_user:
        ...
        cursor.execute('''
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        ''', (user_id, settings.FIRST_SUPERUSER_EMAIL, "admin", "System Administrator",
